Setup procedure originally followed from https://docs.romm.app/4.0.1/OIDC-Guides/OIDC-Setup-With-Authentik/#step-3-register-an-application and preserved below.
